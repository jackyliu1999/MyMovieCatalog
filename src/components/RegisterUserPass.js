...
class RegisterUserPass extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      username: "",
    ...
    return (
      <div className="loginForm">
        ...
        <div className="loginRegister">
          <p style={{ textAlign: "center", color: "black", fontSize: "40px", fontFamily: "Arial", fontWeight: "bold" }}> <img src={logo} style={{ width: "50px" }} class="center" />&nbsp; MyMovieCatalog Registration</p>
          ...
          <div className="loginButton" style={{ textAlign: "center" }}>
            <Button variant="success" onClick={() => this.doRegister()}>Register</Button>{' '}
            <br />
          </div>
        </div>
      </div>
